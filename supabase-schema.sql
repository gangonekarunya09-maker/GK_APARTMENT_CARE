-- ====================================================================
-- THIS FILE IS KEPT IN SYNC WITH supabase/schema.sql (SECURE RLS v2).
-- Edit supabase/schema.sql, then copy it here.
-- ====================================================================
...
-- increment demand via the SECURITY DEFINER RPC in Section 6.
